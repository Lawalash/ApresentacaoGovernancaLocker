    ...
    <div className="h-full flex flex-col md:flex-row gap-12">
      ...
      <div className="flex-1">
        ...
        <div className="space-y-4">
            {[
                "Fluxo Gestão X: Triagem Inicial (Sustentação/Warlean)",
                "Entrada Direta: Opção de 'Implantação' cai na Governança",
                "Filtro de Governança: Priorização e Checklist antes do CMD",
                "Regra de Execução: CMD/TI só atua em chamados escalonados",
                "SLA: Contagem inicia após validação da Governança"
            ].map((item, idx) => (
      ...
      <div className="flex-1">
        ...
        <div className="bg-[#3699BA]/10 rounded-2xl p-8 relative">
            ...
            <ol className="relative border-l border-[#3699BA]/30 ml-3 space-y-8 mt-2">
                {[
                    { title: "Configurar Gestão X", desc: "Criar filas de Triagem (Sustentação) e Governança." },
                    { title: "Comunicar Áreas", desc: "Alinhar novo fluxo com Planejamento e CMD." },
